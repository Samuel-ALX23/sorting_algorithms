...
/**
 * lomuto_partition - Partition a subset of an array of integers using the Lomuto partition scheme.
 ...
 *
 * Description: Uses the Lomuto partition scheme for sorting.
 */
void lomuto_sort(int *array, size_t size, int left, int right)
{
	int partition;
 ...
 * @size: The size of the array.
 *
 * Description: Uses the Lomuto partition scheme. Prints the array after each swap operation.
 */
void quick_sort(int *array, size_t size)
{
